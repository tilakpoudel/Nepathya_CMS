...
<head>
    ...
    <title>{{ config('app.name', 'NepathyaCms') }}</title>
                ...
                <div class="col-lg-3">
                    <ul class="list-group">  
                        ...
                        <li class="list-group-item">
                          ...
                          <li class="list-group-item">
                            <strong><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Teachers</a>
                            <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('teacher.create')}}">Create</a>
